...
function App() {
  ...
  //Criando constantes para receber os dados
  ...
  const [updateData, setUpdateData] = useState(true);
   ...
   //Propriedade de alunos no formulario vazio.
  ...
  return (
    <>
      <div className='usuario-container'>
        ...
        <header>
          <button className='btn btn-primary' onClick={() => abrirFecharModalIncluir() }>Cadastrar</button>
        </header>
        ...
        <Modal isOpen= {modalEditar}>
          ...
          <ModalBody>
           ...
           <ModalFooter>
             ...
             <button className='btn btm-danger' onClick={ () => abrirFecharModalEditar() }>Cancelar</button>
           </ModalFooter>
        </Modal>
        ...
        <Modal isOpen= {modalExcluir}>
          <ModalBody>
            Confirmar a exclusão do usuario(a) : {usuariosSelecionados && usuariosSelecionados.nomeUsu} ? 
          </ModalBody>
          <ModalFooter>
